    ...
    <div className="h-full flex flex-col bg-[#FDFBF7]">
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 print:p-0 print:overflow-visible text-black bg-[#EBEBE4] print:bg-white custom-scrollbar">
        ...
        <div 
          ...
          className="mx-auto bg-white shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-[#E5E5E0] font-serif print:shadow-none print:border-none print:p-0 print:pt-[10mm] print:px-[18mm] print:pb-[12mm] print:m-0 print:max-w-none text-[9.5pt] leading-[1.28] box-border print-document-sheet"
        >
          ...
          <div className="space-y-0 text-justify letter-content text-[9.5pt]">
            ...
            <div className="space-y-0 text-[9.5pt] leading-[1.28]">
              ...
              <div className="text-center font-bold mt-2 mb-0.5 text-[9.5pt] break-before-auto">LARANGAN DAN KEPATUHAN</div>
              <ul className="list-disc pl-6 space-y-0.5 text-[9pt] leading-[1.24]">
            ...
            <div className="mt-3.5 flex justify-between break-inside-avoid text-[9.5pt]">
              <div className="w-[260px]">
                <p className="mb-11"><br/>Pemberi Tugas,<br/>{data.kopCompanyName}</p>
                <p className="font-bold underline">{data.assignerName}</p>
                <p>{data.assignerPosition}</p>
              </div>
              <div className="w-[260px]">
                <p className="mb-11">{data.signPlaceDate}<br/>Penerima Tugas,<br/>PETUGAS PENAGIHAN</p>
