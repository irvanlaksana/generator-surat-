...
export default function SuratPenyerahan({ data, paperSize = 'f4' }: SuratPenyerahanProps) {
  ...
  return (
    <div 
      ...
      className="mx-auto bg-white p-[16mm] text-black font-serif text-[10pt] leading-normal box-border print:p-[14mm] print:shadow-none print:m-0 print:w-full print:min-h-0 print:text-[10pt]"
    >
      {/* Header / Kop */}
